...
const Header = ({ setdrop, drop }) => {
  return (
    <div
      className={`self-end flex bg-transparent items-center shadow-md shadow-secondary transition-all duration-100 rounded-xl border-[2px] border-double border-secondary md:my-4 md:mr-2 drop-shadow-3xl cursor-pointer`}
    >
